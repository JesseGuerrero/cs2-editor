...
public enum ClientScriptOpCode {
    PUSH_INT(79, true),
    LOAD_VARP(154, true),
    STORE_VARP(929, true),
    PUSH_STRING(57, true),
    ...
    instr6064(314),
    CC_SETITEM_WEARCOL(878),
    CC_SETITEM_WEARCOL_NONUM(173),
    instr6895(928),
    ...
    instr6075(223),
    CC_SETOPBASE(275),
    CC_SETTARGETVERB(466),
    CC_CLEAROPS(611),
    CC_SETTARGETCURSORS(627),
    CC_SETOPCURSOR(176),
    CC_SETRESUMETEXT(806),
    CC_SETTARGETOPCURSOR(659),
    CC_SETOPCHAR(66),
    CC_SETOPTCHAR(749),
    CC_SETOPKEY(895),
    CC_SETOPTKEY(67),
    CC_SETMOUSEOVERCURSOR(219),
    instr6088(813),
    instr5957(158),
    instr6450(374),
    instr6091(1),
    ...
    public static final HashMap<Integer, ClientScriptOpCode> OPCODES = new HashMap<>();

    static {
        for (ClientScriptOpCode op : ClientScriptOpCode.values()) {
    ...
    ClientScriptOpCode(int opcode) {
        this(opcode, false);
    }

    ClientScriptOpCode(int opcode, boolean hasIntConstant) {
        this.opcode = opcode;
        this.hasIntConstant = hasIntConstant;
    }

    public static ClientScriptOpCode getByOpcode(int id) {
